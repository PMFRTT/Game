...
public class WaterRenderer {
	...
	private static final String UVMAP = "waterUVMap";
	...
	public WaterRenderer(Loader loader, WaterShader shader, Matrix4f projectionMatrix, WaterFrameBuffers fbos) {
		this.shader = shader;
		this.fbos = fbos;
		UVTexture = loader.loadTexture(UVMAP);
	...
	private void prepareRender(Camera camera, Light light){
		...
		moveFactor += (WAVE_SPEED * (DisplayMaster.getFrameTimeMillis() / 1000));
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, UVTexture);
